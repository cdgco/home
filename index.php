...
?>
    ...
    <head>
        ...
        <link id="style1" rel="stylesheet" href="css/<?php require( 'includes/grab/light3.php'); ?>.css"> </head>
    ...
    <body id="htinsert" onload="startTime()">
        ...
        <div class="container">
            <div class="switch white">
                <?php require( 'includes/grab/light.php'); ?>
                    <label>Day</label>
                    <label>Night</label> <span class="toggle"></span> </div>
            <!-- end switch -->
        </div>
        <!-- end container -->
        <?php
      ...
      <span class="tile-content"><center><br><br><span class="title" style="font-size:80px;"><div id="time"></div></span> <span class="title"><?php echo date("l F j Y") . "<br>"; ?></span></center> <span class="tile-holder tile-holder-sm">
        </span> </span>
                    </span>
                    </center>
                </a>
                <a class="tile tile-lg tile-sqr tile-purple ripple-effect" id="emaila" href="https://mail.google.com/mail/u/0/#inbox"> <span class="content-wrapper">
      <span id="gmaildiv" class="tile-content"><center><?php require( 'includes/grab/email.php'); ?></span> </span>
                    </span>
                </a>
                <a class="tile tile-lg tile-sqr tile-cyan ripple-effect" href="#"> <span class="content-wrapper">
      <span class="tile-content">
        <span class="tile-holder tile-holder-sm">
          <span class="title"></span> </span>
                ...
                <a class="tile tile-lg tile-sqr tile-amber ripple-effect" href="#"> <span class="content-wrapper">
      <span class="tile-content">
        <span class="tile-holder tile-holder-sm">
          <span class="title"></span> </span>
                    </span>
                    </span>
                </a> <span class="tile tile-lg tile-light-blue ripple-effect">
...
</span> <span class="title">Recent News</span> </span>
                </span>
                </span>
                </span>
                <a class="tile tile-lg tile-sqr tile-red ripple-effect" href="#"> <span>
      <span><center><iframe class="ripple-effect spotify" src="https://open.spotify.com/embed?uri=<?php require( 'includes/grab/spotify.php'); ?>&view=coverart" frameborder="0" height="280" width="270" allowtransparency="true"></iframe></center>
        ...
        <span class="tile-holder tile-holder-sm">
          <span class="title"></span> </span>
                ...
                <a class="tile tile-lg tile-sqr tile-indigo ripple-effect" href="<?php if(!$user->is_logged_in()){ echo " login.php "; } else {echo "account.php ";}; ?>"> <span class="content-wrapper">
      <span class="tile-content">
<br><br><center><img src="<?php if(!$user->is_logged_in()){ echo "img/user.png"; } else {echo "img/settings.png";}; ?>" height="120"></center><br>
        <span class="tile-holder tile-holder-sm">
          <span class="title"><?php if(!$user->is_logged_in()){ echo "Login"; } else {echo "Settings";}; ?></span> </span>
                    </span>
                    </span>
                </a>
                <a class="tile tile-lg tile-sqr tile-deep-orange ripple-effect" href="#"> <span class="content-wrapper">
      <span class="tile-content">
        <span class="tile-holder tile-holder-sm">
          <span class="title"></span> </span>
                    </span>
                    </span>
                </a> <a class="tile tile-lg tile-light-green ripple-effect" id="weatherblock" "href="# ">
    <span class="content-wrapper ">
      <span class="tile-content ">
        ...
        <span class="tile-holder tile-holder-sm ">
                ...
                <script>
                    ...
                    xhr.setRequestHeader("authorization", "Bearer <?php
                            require('includes/dbconnect.php'); $res = mysql_query("SELECT token FROM members WHERE memberID = '$memid'"); $userRow = mysql_fetch_row($res); $gtoken = $userRow[0]; echo $gtoken; ? > ");
                            xhr.send(data);

                            function toggle() {
                                var a = document.getElementById("style1");
                                a.x = 'css/<?php require('
                                includes / grab / light2.php '); ?>' == a.x ? 'css/<?php require('
                                includes / grab / light3.php '); ?>': 'css/<?php require('
                                includes / grab / light2.php '); ?>';
                                a.href = a.x + '.css';
                            }
                            $(function () {
