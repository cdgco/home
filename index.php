...
<span class="title"><?php echo date("l F j Y") . "<br>"; ?></span></center>
  ...
  <a class="tile tile-lg tile-sqr tile-purple ripple-effect" id="emaila" href="https://mail.google.com/mail/u/0/#inbox">
    <span class="content-wrapper">
      <span id="gmaildiv" class="tile-content"><center><?php require( 'includes/grab/email.php'); ?></span>
      </span>      
    </span>
  </a>
...
if (jsonResponse["threadsUnread"] == null){
    ...
    document.body.innerHTML = document.body.innerHTML + '<div class="tooltip"><a href="includes/quickauth.php"><img alt="Login to Gmail" class="hover" style="display:inline;position: fixed;bottom: 4%;left: 2%; height:80px;" src="img/auth.png"/></a> <span class="tooltiptext">Login to Gmail</span></div>';
}
else {
