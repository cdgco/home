...
<body id="htinsert" onload="startTime()">
    ...
    <div class="dashboard display-animation" style="position:relative; top: -15px;margin: 0 auto; width: 1130px;">
        ...
        <a class="tile tile-lg tile-sqr tile-purple ripple-effect" id="emaila" href="https://mail.google.com/mail/u/0/#inbox">
            <span class="content-wrapper">
                <span id="gmaildiv" class="tile-content">
                    <center><?php require('includes/grab/email.php'); ?></center>
                </span>
            </span>
        </a>
        ...
        <a class="tile tile-lg tile-sqr tile-indigo ripple-effect" href="<?php if (!$user->is_logged_in()) {
                                                                                echo "login.php";
                                                                            } else {
                                                                                echo "account.php";
                                                                            }; ?>">
            <span class="content-wrapper">
                <span class="tile-content"><br><br>
                    <center>
                        <img src="<?php if (!$user->is_logged_in()) {
                                        echo "img/user.png";
                                    } else {
                                        echo "img/settings.png";
                                    }; ?>" height="120">
                    </center><br>

                    <span class="tile-holder tile-holder-sm">
                        <span class="title"><?php if (!$user->is_logged_in()) {
                                                echo "Login";
                                            } else {
                                                echo "Settings";
                                            }; ?></span>
    ...
    <script>
        ...
        $.get("https://ipinfo.io", function(response) {
            ...
            $.get("https://api.openweathermap.org/data/2.5/weather?<?php require('includes/grab/weather.php'); ?>&appid=<?php echo OWAPIKEY; ?>" + tempunit, function(response) {
                ...
                $("#weather2").html(response.weather.icon);
        ...
        xhr.addEventListener("readystatechange", function() {
            if (this.readyState === 4) {
                ...
                if (jsonResponse["threadsUnread"] == null) {
                    ...
                    var loggedin = '<?php if (!$user->is_logged_in()) {
                                        echo 'no';
                                    } else {
                                        echo 'yes';
                                    } ?>';
