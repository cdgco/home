...
<h4 id="email"></h4> 
<form action="tokencheck.php" method="post">
<input name="token" type="text" style="display:none;" id="hiddeninput"></input><br>
<input type="submit" value="Verify"/>
</form></center>
<script src="https://apis.google.com/js/platform.js" async defer></script>
<meta name="google-signin-client_id" content="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX.apps.googleusercontent.com">
